...
class CalendarComponent extends Component {
	...
	function convertAdtoJa($date) {
		try {
			...
			if(strtotime($date) < '1556636400'){
                                $b = "平成".(intval($date) - 1988)."年".date("n", strtotime($date))."月".date("j", strtotime($date))."日";
                                } else {
                                if(intval($date) - 2018 == 1){
                                $b = "令和元"."年".date("n", strtotime($date))."月".date("j", strtotime($date))."日";
                                } else {
                                $b = "令和".(intval($date) - 2018)."年".date("n", strtotime($date))."月".date("j", strtotime($date))."日";
                                }}
...
*/			
	...
	function convertAdtoJaYear($year_ad) {
		try {
                        ...
                        if(strtotime($year_ad) < '1556636400'){
                                $a = "平成".(intval($year_ad) - 1988);
                                } else {
                                if(intval($year_ad) - 2018 == 1){
                                $a = "令和元";
                                } else {
                                $a = "令和".(intval($year_ad) - 2018);
                                }}
			$year_ja = $a;
