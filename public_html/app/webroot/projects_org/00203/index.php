...
<span style="font-size:12px;">※写真はイメージです。</span>
					<div id="ps-left_2">
							...
							<table id="project-simulator2">
								<tr>
									...
									<td class="ps2_title2_new" id="ps2_title3">セブンスター</td>
								</tr>
								<tr>
				...
				<div id="project-shousai-right"> <!-- 右側：案件概要 -->
					<div style="overflow: auto;margin: 0;padding: 0;">
						...
						<table id="fund_status">
							...
							<tr><td class="fund_status_title">運用日数</td><td class="fund_status_s3"><?php echo $remaining_time_day ?>日</td></tr>
							<tr><td class="fund_status_title">貸付条件</td><td><small>※下記ローンファンド詳細の各案件をご確認ください。</small></td></tr>
							<tr><td colspan="2"><small style="color: red;">（※１）上記の賃貸事業損益から優先募集総額に予定分配率（年利）を乗じ、計算期間に応じて1年を365日とする日割り計算で算出した金額を上限に投資家様へ分配を行います。</small></td></tr>
						</table>
            ...
            <div id="ui-tab" style="margin-top: 20px;"> <!-- 案件内容 -->
                <ul class="tab_menu">
                    ...
                    <li><a href="#tab3">案件3</a></li>
                    <li><a href="#tab4">案件4</a></li>
                </ul>
...
本ファンドおよび燃料卸売事業者ローンファンド193～200号の募集を含め、後記【担保】に記載の内容を担保として総額450,000,000円の募集を行っております。<br>
<br>
※燃料卸売事業者ローンファンド193～200号と同一案件の追加募集となります。本借入人の資金需要の状況によって、今後更なる追加募集の可能性があります。<br> 
※本ファンドの募集が成立した場合であっても、想定通りのスキーム構築や前提条件が整わない場合には、貸付を見送る可能性があります。その場合には、出資金は無利息でお客様に返金させて頂くこととなります。
			...
			　　<tr><th>想定利回り<br>（税引前）</th><td class="center_align">11.00%</td></tr>
			　　<tr><th>営業者報酬</th><td class="center_align">1.50%</td></tr>
                            <tr><th>借入期間</th><td class="center_align">23ヶ月</td></tr>
...
※本ファンドでの運用予定期間は23ヶ月としておりますが、事業成長により想定を超える収益拡大となった場合には、ファンド単位で出資金の早期償還となることが見込まれます。<br>
<BR>
...
※返済リスクに関する注意点は、後記【投資に関する注意点】の内容をよくご確認ください。
					...
					<div class="tab_naiyou_right">
                        <table>
                            ...
                            <tr><th>貸付利率</th><td class="center_align">12.50%</td></tr>
							<tr><th>想定利回り（税引前）</th><td class="center_align">11.00%</td></tr>
							<tr><th>営業者報酬</th><td class="center_align">1.50%</td></tr>
                            <tr><th>借入期間</th><td class="center_align">23ヶ月</td></tr>
                            <tr><th>返済方法</th><td>元金一括返済（期限前償還あり）</td></tr>
