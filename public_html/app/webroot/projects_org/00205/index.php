...
<span style="font-size:12px;">※写真はイメージです。</span>
            ...
            <div id="ui-tab" style="margin-top: 20px;"> <!-- 案件内容 -->
                ...
                <div id="tab1" class="tab_content">
                    <div id="tabtitle"><b>動産担保付事業者ローン</b></div> <!-- 案件1 -->
...
<span class="supText"></span>県内に砂利採取事業者が少なく、競合が少ないことが強みで、現在国を発注者とする大規模な公共工事プロジェクト（以下、「本件プロジェクト」といいます。）に参画中です。
                        ...
                        <dl>
                    		<dt>【借入の目的】</dt>
                    		<dd class="padd_20">
                    			本借入人は地方防衛局からの発注を受けた大手スーパーゼネコンJVより総額約４０億円（本ファンド募集時点）の発注を受けており、本ファンド及び今後トラストレンディングが組成するローンファンドから、本件プロジェクトで使用する購入資金（資金使途の詳細は、後記【資金使途】をご確認ください。）を借り入れ、当該資金で新たに砂利採取現場で使用する大型重機を購入し稼働させることで、本件プロジェクトの業務遂行を加速させることを期待しています。
<br>
                    		</dd>
...
<br>
本ファンドの募集を含めて総額100,000,000円の募集を予定しております。追加募集につきましては本借入人の資金需要の状況に応じて適宜ご案内させて頂きます。<BR>
<BR>
※募集予定総額は現時点のものであり、経済状況・購入予定動産の取得状況等により今後増減する可能性があります。
<BR>
                    		</dd>
                        </dl>
                        </dl>
			...
			　　<tr><th>想定利回り<br>（税引前）</th><td class="center_align">10.00%</td></tr>
			　　<tr><th>営業者報酬</th><td class="center_align">5.00%</td></tr>
                            <tr><th>借入期間</th><td class="center_align">18ヶ月</td></tr>
                    ...
                    <div class="tab_naiyou2">
                        ...
                        <dl>
                    		<dt>【担保】</dt>
                    		<dd class="padd_20">
					取得予定の大型重機に対し、当該大型重機を購入後、速やかに動産譲渡登記を行います。<BR>
<Br>
※購入予定動産の所有者は手続きの関係で本借入人の関連会社を予定しております。
<Br>
...
<Br>
					...
					本件貸付は、本借入人の代表者が連帯保証を致します。
                        ...
                        <dl>
                    		...
                    		<dt>【資金使途】</dt>
                    		<dd class="padd_20">
                    			以下の事業資金・運転資金として使用する予定です。<dl>
　① 大型重機の取得代金<BR>
　② 取得予定の大型重機の維持・メンテナンス費用・燃料費用<BR>
　③ 動産譲渡登記にかかる諸費用<BR>
　④ 本ファンド借入の経過利息<BR>
　⑤ 上記各号に付随する費用<BR>
<br>※資金使途は、経済状況や本借入人の信用状況等により変更される場合があります。
                        ...
                        <dl>
                    		<dt>【返済原資】</dt>
                    		<dd class="padd_20">本件は、総事業費約３５００億円（２０１４年３月時点）規模の公共事業の工事のうちの一部であり、砂利採掘権を保有し運営主体となる本借入人による砂利供給・運搬に伴う事業収益により返済を予定しております。当社は、本借入人との面談ヒアリングを行い、本件プロジェクトに関して受領した事業収支計画表や過去の営業実績に基づき、当該事業収支計画の妥当性を検討した結果、本ファンドの借入金の返済は十分に可能であると判断しました。
...
<li>決算書</li>
<li>取得予定の大型重機の注文書・注文請書</li>
<li>取得予定の大型重機のカタログ</li>
<li>本借入人の事業収支計画表</li>
...
※返済リスクに関する注意点は、後記【投資に関する注意点】の内容をよくご確認ください。
					...
					<div class="tab_naiyou_right">
                        <table>
                            ...
                            <tr><th>貸付利率</th><td class="center_align">15.00%</td></tr>
							<tr><th>想定利回り（税引前）</th><td class="center_align">10.00%</td></tr>
							<tr><th>営業者報酬</th><td class="center_align">5.00%</td></tr>
                            <tr><th>借入期間</th><td class="center_align">18ヶ月</td></tr>
                            <tr><th>返済方法</th><td>元金一括返済（期限前償還あり）</td></tr>
