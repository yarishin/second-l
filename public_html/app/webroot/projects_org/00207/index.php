				...
				<div id="project-shousai-right"> <!-- 右側：案件概要 -->
					<div style="overflow: auto;margin: 0;padding: 0;">
						...
						<table id="fund_status">
							...
							<tr><td class="fund_status_title">運用日数</td><td class="fund_status_s3"><?php echo $operating_term * 31 ?>日</td></tr>
...
本ファンドおよび燃料卸売事業者ローンファンド193～200号、203号の募集を含め、後記【担保】に記載の内容を担保として総額498,600,000円の募集を行っております。<br>
<br>
※燃料卸売事業者ローンファンド193～200号および203号と同一案件の追加募集となります。本借入人の資金需要の状況によって、今後更なる追加募集の可能性があります。<br> 
