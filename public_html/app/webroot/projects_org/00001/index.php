								...
								<dd>
									...
									<div class="col-md-6 col-xs-12" style="overflow: auto;margin: 10px 0 20px 0;">
										<table style="width: 100%;">
											...
											<tr><td style="padding: 5px;">JR山手線　高輪ゲートウェイ駅より徒歩10分</td></tr>
											<tr><td style="padding: 5px;">京浜東北線　高輪ゲートウェイ駅より徒歩10分</td></tr>
											<tr><td style="padding: 5px;">JR東海道線　品川駅より徒歩15分</td></tr>
										</table>
									</div>
									<div class="col-md-6 col-xs-12" style="overflow: auto;margin: 10px 0 20px 0;">
										<table style="width: 100%;">
											<tr><th style="padding: 5px;">周辺施設</th></tr>
											<tr><td style="padding: 5px;">セブンイレブン高輪南店　徒歩5分</td></tr>
											<tr><td style="padding: 5px;">ファミリーマート品川高輪口店　徒歩7分</td></tr>
											<tr><td style="padding: 5px;">高輪公園　徒歩10分</td></tr>
										</table>
									</div>
								</dd>
							</dl>
							...
							<dl class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s">
								...
								<dd style="padding: 10px;">
									<div class="col-sm-7">
										...
										▼街のブランド力<br>
										周辺にはハイクラスなマンションやホテルなどが多く洗練された雰囲気があり、都会なのに落ち着いて住みやすい環境に恵まれています。
										また、六本木や麻布十番などの人気エリアへのアクセスもよく好立地としても知られています。
										そして白金児童遊園のような公園も周りにあり、子育てがしやすいというところもメリットもあります。<br>
										▼街の将来性<br>
										今ある施設に加えて、新たな施設の整備を行う予定です。その他にも自転車と歩行者の通行を分けて、歩行者の安全を確保するような歩道を整備したり、自転車が安全　　　　　　　　　　　　　　　　　　　　に走行できる空間を整備したり、あらゆる人が暮らしやすい街づくりを計画しています。
									</div>
