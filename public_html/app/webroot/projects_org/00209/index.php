                ...
                <div id="tab1" class="tab_content">
                    ...
                    <div class="tab_naiyou">
                        <dl>
                    		<dt>【借入人の概要】</dt>
                    		<dd class="padd_20">
                    			本借入人は東京都内に本社を置き、衛生面向上や環境改善といった領域で事業を行っておりますが、新規事業として燃料の流通に関わるビジネスの立ち上げを進めており、このたび特定の地域と用途に対する燃料の商流に卸売業者として参入すること（以下、「本事業」と言います）が確定致しました。本事業向けにSPCを設立しており、当該SPCを経由しての貸付となります。<br>
...
本ファンドおよび燃料卸売事業者ローンファンド193～200号、203号、207号、208号の募集を含め、後記【担保】に記載の内容を担保として総額598,600,000円の募集を行っております。<br>
<br>
※燃料卸売事業者ローンファンド193～200号、203号、207号、208号と同一案件の追加募集となります。本借入人の資金需要の状況によって、今後更なる追加募集の可能性があります。<br> 
※本ファンドの募集が成立した場合であっても、想定通りのスキーム構築や前提条件が整わない場合には、貸付を見送る可能性があります。その場合には、出資金は無利息でお客様に返金させて頂くこととなります。
		            ...
		            <tr><th>貸付金額</th><td class="center_align">50,000,000円</td></tr>
                            <tr><th>貸付利率</th><td class="center_align">10.50%</td></tr>
			　　<tr><th>想定利回り<br>（税引前）</th><td class="center_align">8.00%</td></tr>
			　　<tr><th>営業者報酬</th><td class="center_align">2.50%</td></tr>
                            <tr><th>借入期間</th><td class="center_align">19ヶ月</td></tr>
...
※本ファンドでの運用予定期間は19ヶ月としておりますが、事業成長により想定を超える収益拡大となった場合には、ファンド単位で出資金の早期償還となることが見込まれます。<br>
<BR>
...
※返済リスクに関する注意点は、後記【投資に関する注意点】の内容をよくご確認ください。
					...
					<div class="tab_naiyou_right">
                        <table>
                            ...
                            <tr><th>貸付利率</th><td class="center_align">10.50%</td></tr>
							<tr><th>想定利回り（税引前）</th><td class="center_align">8.00%</td></tr>
							<tr><th>営業者報酬</th><td class="center_align">2.50%</td></tr>
                            <tr><th>借入期間</th><td class="center_align">19ヶ月</td></tr>
                            <tr><th>返済方法</th><td>元金一括返済（期限前償還あり）</td></tr>
