...
<?php CommonTag::header(); ?>
        ...
        <div class="g-bg-color--sky-light">
            <div class="container g-padding-y-80--xs g-padding-y-125--xsm">
                    ...
                    <div class="col-md-8 g-margin-b-0--xs g-margin-b-0--lg">
                        <div class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <div class="g-text-center--xs">
								...
								<div id="slider-area">
									<ul class="thumb-item">
										 <li><img src="img/thumbnail_img001.jpg" alt="slide01" /></li>
										 ...
										 <li><img src="img/prj_img_04.jpg" alt="slide05" /></li>
										 <li><img src="img/prj_img_05.jpg" alt="slide06" /></li>
									</ul>
									<!-- ↓サムネイル -->
									<ul class="thumb-item-nav">
										 <li class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s"><img src="img/thumbnail_img001.jpg" alt="slide01" /></li>
										 ...
										 <li class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".9s"><img src="img/prj_img_04.jpg" alt="slide05" /></li>
										 <li class="wow fadeIn" data-wow-duration=".3" data-wow-delay="1.2s"><img src="img/prj_img_05.jpg" alt="slide06" /></li>
									</ul>
								</div>
				...
				<div>
					<!-- タブ・メニュー -->
					<ul id="project-tab" class="nav nav-tabs btn-group">
						<li class="btn btn-primary2 active" style="padding: 6px 0;width: 20%;"><a href="#ContentA" data-toggle="tab"><i class="material-icons visible-sm visible-xs">apartment</i><span class="g-font-size-15--md g-font-size-20--sm" style="font-weight:700;">プロジェクト</span></a></li>
						<li class="btn btn-primary2" style="padding: 6px 0;width: 20%;"><a href="#ContentB" data-toggle="tab"><i class="material-icons visible-sm visible-xs">location_on</i><span class="g-font-size-15--md g-font-size-20--sm" style="font-weight:600;">物件情報</span></a></li>
						<li class="btn btn-primary2" style="padding: 6px 0;width: 20%;"><a href="#ContentC" data-toggle="tab"><i class="material-icons visible-sm visible-xs">subject</i><span class="g-font-size-15--md g-font-size-20--sm" style="font-weight:600;">投資スキーム</span></a></li>
						<li class="btn btn-primary2" style="padding: 6px 0;width: 20%;"><a href="#ContentD" data-toggle="tab"><i class="material-icons visible-sm visible-xs">announcement</i><span class="g-font-size-15--md g-font-size-20--sm" style="font-weight:600;">リスク案内</span></a></li>
						<?php if (isset($_SESSION[SESSION_LOGIN_USER_INFO])) { ?>
							<li class="btn btn-primary2" style="padding: 6px 0;width: 20%;"><a href="#ContentE" data-toggle="tab"><i class="material-icons visible-sm visible-xs">description</i><span class="g-font-size-15--md g-font-size-20--sm" style="font-weight:600;">添付書類</span></a></li>
						<?php } else { ?>
							<li class="btn btn-primary2 disabled" style="padding: 6px 0;width: 20%;" title="会員限定"><i class="material-icons visible-sm visible-xs">description</i><span class="g-font-size-15--md g-font-size-20--sm" style="font-weight:600;">添付書類</span></li>
						<?php }	?>
					</ul>
							...
							<dl class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s">
									...
									<div class="col-md-12 col-xs-12">
										<table class="table table-striped" style="border: 1px solid #cccccc;">
											<tbody>
												...
												<tr><th style="width: 50%;text-align: center;">2017年 1 ～ 6月</th><td style="width: 50%;text-align: center;">100</td></tr>
												...
												<tr><th style="width: 50%;text-align: center;">2019年 7 ～ 12月</th><td style="width: 50%;text-align: center;">100</td></tr>
											</tbody>
										</table>
									</div>
									<?php
								...
								<dd>
									...
									<div class="center-block" style="border-bottom: 1px solid #999999;margin: 10px;overflow: auto;">									
										...
										<div class="col-sm-6 g-padding-y-5--xs g-text-left--sm g-text-center--xs">
											<?php echo date('Y年n月j日', strtotime($initial_distribution_schedule)) ?>　　<?php echo $cycle ?>
										</div>
									</div>
							...
							<dl class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s">
								...
								<dd>
									<div id="gmap-area" style="margin-top: 20px;overflow: hidden;">
										<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3240.167267818378!2d139.70770921555115!3d35.69750123668628!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188cde4eb8cc09%3A0xecca4306f1e0486f!2z44CSMTYwLTAwMjIg5p2x5Lqs6YO95paw5a6_5Yy65paw5a6_77yW5LiB55uu77yS77yX4oiS77yV77yR!5e0!3m2!1sja!2sjp!4v1605838878119!5m2!1sja!2sjp" width="100%" height="350" frameborder="0" style="border: 1px solid #cccccc;margin-bottom: 10px;" allowfullscreen=""></iframe>
									</div>
									<div class="col-md-6 col-xs-12" style="overflow: auto;margin: 10px 0 20px 0;">
										<table style="width: 100%;">
											<tr><th style="padding: 5px;">交通・アクセス</th></tr>
											<tr><td style="padding: 5px;">都営大江戸線「東新宿」駅より徒歩4分</td></tr>
											<tr><td style="padding: 5px;">ＪＲ山手線「新宿駅」駅より徒歩17分</td></tr>
										</table>
									</div>
									<div class="col-md-6 col-xs-12" style="overflow: auto;margin: 10px 0 20px 0;">
										<table style="width: 100%;">
											<tr><th style="padding: 5px;">周辺施設</th></tr>
											<tr><td style="padding: 5px;">「ポプラ 東大久保店」徒歩約1分</td></tr>
											<tr><td style="padding: 5px;">「セブンイレブン 新宿7丁目店」徒歩約3分</td></tr>
											<tr><td style="padding: 5px;">「マルエツ 新宿六丁目店」徒歩約4分</td></tr>
										</table>
									</div>
								</dd>
							</dl>
							...
							<dl class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s">
								...
								<dd style="padding: 10px;">
									<div class="col-sm-7">
										...
										▼街のブランド力<br>
										メイクスデザイン東新宿の近隣にはコンビニやスーパーといった生活利便施設が所在しています。最寄駅である都営大江戸線「東新宿」駅まで徒歩約4分のほか、ＪＲ山手線「新宿」駅も徒歩圏内です。
それぞれの駅から都心部の主要駅に乗り換えなしで行くことができ、交通アクセスの良い物件です。<br>
										▼街の将来性<br>
										マンションの造成が進み利用者数が増加し、2012年には商業&ビジネス複合型のオフィスビル「新宿イーストサイドスクエア」が建設され駅に直結したほか、駅東部には区民の生活交流施設が集まるなど、区民向けのインフラ整備もされ、現在も再開発が進んでいます。
									</div>
									<div class="col-sm-5" style="height: 300px;margin-top:1em;">
										<img src="img/cityscape.jpg" class="img-responsive">
									</div>
								</dd>
							</dl>
							...
							<dl class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s">
								<dt>＜賃料相場＞</dt>
								<dd>
									<div class="col-md-12 col-xs-12" style="margin: 10px 0 20px 0;">
										<table class="table table-bordered" style="width: 100%;">
											<tr><td>			</td><td style="text-align: center;">情報誌</td><td style="text-align: center;">サイト</td></tr>
											<tr><td>ワンルーム	</td><td style="text-align: right;">100,000</td><td style="text-align: right;">97,000</td></tr>
											<tr><td>１Ｋ		</td><td style="text-align: right;">115,000</td><td style="text-align: right;">110,000</td></tr>
										</table>
									</div>
<!--
...
-->
						...
						<div class="tab-pane" id="ContentE" style="padding: 10px;background-color: #fff;height: 100vh;border: 1px solid #666666;">
							<dl class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s">
								...
								<dd>
									<ul>
										<!--<li><a href="template/sample1.pdf" target="_blank">図面</a></li>
										<li><a href="template/sample2.pdf" target="_blank">不動産調査報告書概要</a></li> -->
										<li><a href="template/sample3.pdf" target="_blank">管理規約</a></li>        
									</ul>
								</dd>
							</dl>
						</div>
