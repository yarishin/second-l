...
<?php CommonTag::header(); ?>
    ...
    <div id="header_under">
       <div id="breadcrumb-area"><a href='<?php echo URL_SITE_TOP ?>'>HOME</a> > 2017/06/30 キャンペーン終了のお知らせ</div>
    </div>
    ...
    <div id="content">
		...
		<div id="topics_area">
			<div id="ta_main">
				<div id="ta_text-r">2017/06/30</div>
				<div id="ta_main-title">キャンペーン終了のお知らせ</div>
				<div id="ta_shousai">
					<p>
						お客様各位<br /><br />
						平素はトラストレンディングをご利用いただき、誠にありがとうございます。<br /><br />
						皆様からご好評をいただきました、<br />以下のキャンペーンは2017/06/30　17：00を持ちまして終了となりました。<br /><br />
