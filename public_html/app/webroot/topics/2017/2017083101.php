...
<?php CommonTag::header(); ?>
    ...
    <div id="header_under">
       <div id="breadcrumb-area"><a href='<?php echo URL_SITE_TOP ?>'>HOME</a> > 2017/08/31 サーバーメンテナンスによるサービス停止のお知らせ</div>
    </div>
    ...
    <div id="content">
		...
		<div id="topics_area">
			<div id="ta_main">
				<div id="ta_text-r">2017/08/31</div>
				<div id="ta_main-title">サーバーメンテナンスによるサービス停止のお知らせ</div>
				<div id="ta_shousai">
					<p>
						お客様各位<br /><br />
						平素はトラストレンディングをご利用いただき、誠にありがとうございます。<br /><br />
						この度、サーバーメンテナンスに伴い、下記日程にてサービスを一時的に停止させていただきます。サービスのご利用を含め、当Webサイト全てのページの閲覧ができなくなりますので予めご了承ください。<br /><br />
					...
					<dl>
						<dt>【サービス停止日時】</dt>
						<dd>
							2017年08月31日（木）18：30 ～ 19：30 ごろまで
						</dd>
