...
<?php CommonTag::header(); ?>
    ...
    <div id="header_under">
       <div id="breadcrumb-area"><a href='<?php echo URL_SITE_TOP ?>'>HOME</a> > 2018/10/01 社員研修に伴う電話対応サービス終了時間の繰り上げのお知らせ</div>
    </div>
    ...
    <div id="content">
		...
		<div id="topics_area">
			<div id="ta_main">
				<div id="ta_text-r">2018/10/01</div>
				<div id="ta_main-title">社員研修に伴う電話対応サービス終了時間の繰り上げのお知らせ</div>
				<div id="ta_shousai">
					<p>
						お客様各位<br /><br />
						平素はトラストレンディングをご利用いただき、誠にありがとうございます。<br />
						さて、誠に勝手ながら10月3日（水）は社員研修のため、お電話での問合わせ対応時間を60分繰り上げて終了させていただきます。
					</p>
					...
					<dl>
						<dd>
							<table id="topics_2015120201_table">
								<tr><th><span>10月</span></th><td class="right_align">2</td><td>火</td><td class="center_align">通常営業</td><td>10：00 ～ 18：00</td></tr>
								<tr><td colspan="2" class="right_align">3</td><td>水</td><td class="center_align">繰り上げ</td><td>10：00 ～ <font style="color: red;">17：00</font></td></tr>
