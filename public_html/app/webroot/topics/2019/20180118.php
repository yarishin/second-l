...
<?php CommonTag::header(); ?>
    ...
    <div id="header_under">
       <div id="breadcrumb-area"><a href='<?php echo URL_SITE_TOP ?>'>HOME</a> > 2018/01/18 年間取引報告書発送のお知らせ</div>
    </div>
    ...
    <div id="content">
		...
		<div id="topics_area">
			<div id="ta_main">
				<div id="ta_text-r">2018/01/18</div>
				<div id="ta_main-title">年間取引報告書発送のお知らせ</div>
				<div id="ta_shousai">
					<p>
						お客様各位<br /><br />
						平素はトラストレンディングをご利用いただき、誠にありがとうございます。<br /><br />
						平成29年度の年間取引報告書を発送致しました。<br />
<br /><br />
トラストレンディング運用にかかる確定申告用の資料としてご利用頂ければと存じます。
<br />
確定申告のお手続きになどの詳細につきましては、
お近くの税務署、又は顧問税理士の方へ
