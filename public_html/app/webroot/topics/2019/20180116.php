...
<?php CommonTag::header(); ?>
    ...
    <div id="header_under">
       <div id="breadcrumb-area"><a href='<?php echo URL_SITE_TOP ?>'>HOME</a> > 2018/01/16 サーバーメンテナンスによるサービス停止のお知らせ</div>
    </div>
    ...
    <div id="content">
		...
		<div id="topics_area">
			<div id="ta_main">
				<div id="ta_text-r">2018/01/16</div>
...
<br /><br />
					...
					<dl>
						<dt>【サービス停止日時】</dt>
						<dd>
							2018年01月19日（金）17：00 ～ 2018年01月22日（月）17：00 ごろまで
						</dd>
