...
<form id="form" name="form" method="post" action="<?php echo $action ?>">
	<div id="horizontal">
		<input class="button" type="submit" id="<?php echo OBJECT_ID_BTN000010 ?>" value="戻る" onclick="buttonClick('<?php echo EVENT_ID_050270010 ?>');" tabindex="1">
		<input class="button" type="submit" id="<?php echo OBJECT_ID_BTN000020 ?>" value="一覧" onclick="buttonClick('<?php echo EVENT_ID_050270020 ?>');" tabindex="2">
		<input class="button" type="submit" id="<?php echo OBJECT_ID_BTN000030 ?>" value="メニュー" onclick="buttonClick('<?php echo EVENT_ID_050270030 ?>');" tabindex="3">
	</div>
	<div id="horizontal">
...
<?php if (isset($date_list) && is_array($date_list) && count($date_list) > 0) { ?>
		...
		<input class="button" type="submit" id="<?php echo OBJECT_ID_BTN000040 ?>" value="表示" onclick="buttonClick('<?php echo EVENT_ID_050270040 ?>');" tabindex="5">&nbsp;&nbsp;&nbsp;
<?php } ?>
		<input class="button" type="submit" id="<?php echo OBJECT_ID_BTN000050 ?>" value="新規追加" onclick="buttonClick('<?php echo EVENT_ID_050270050 ?>');" tabindex="6">
	</div>
	<br>
