<?php $inv_list_path = "../".REDIRECT_C050."/".REDIRECT_A050070."?".GET_PARAM_INDEX_FUND_ID."=".$data[OBJECT_ID_050130010]; ?>
...
<?php $this->Html->scriptEnd(); ?>
	...
	<p class="admin-pagetitle">ファンド詳細（照会）</p>
	<div id="horizontal">
		<input class="button" type="button" id="<?php echo OBJECT_ID_BTN000010 ?>" value="修正" onclick="buttonClick('<?php echo EVENT_ID_050120010 ?>');" tabindex="1">
		<input class="button" type="button" id="<?php echo OBJECT_ID_BTN000030 ?>" value="一覧" onclick="buttonClick('<?php echo EVENT_ID_050120030 ?>');" tabindex="3">
		<input class="button" type="button" id="<?php echo OBJECT_ID_BTN000040 ?>" value="メニュー" onclick="buttonClick('<?php echo EVENT_ID_050120040 ?>');" tabindex="4">
		<input class="button" type="button" id="<?php echo OBJECT_ID_BTN000050 ?>" value="財産管理報告書" onclick="buttonClick('<?php echo EVENT_ID_050120070 ?>');" tabindex="5">
	</div>
	...
	<div class="v120">
		<div id="v120-left">
			...
			<div id="horizontal">
				...
				<div><input class="label300" type="text" name="<?php echo OBJECT_ID_050130020 ?>" id="<?php echo OBJECT_ID_050130020 ?>" value="<?php echo $data[OBJECT_ID_050130020] ?>" readonly></div>
			</div>
			<div id="horizontal">
				...
				<div id="label100">　　現在：</div>
				<div><input class="label100_right" type="text" name="<?php echo OBJECT_ID_050130190 ?>" id="<?php echo OBJECT_ID_050130190 ?>" value="<?php echo $data[OBJECT_ID_050130190] ?>" readonly></div>
				<input class="button" type="button" id="<?php echo OBJECT_ID_BTN000050 ?>" value="出資一覧"  onclick="window.open('<?php echo $inv_list_path ?>')">
			</div>
			<div id="horizontal">
...
if (isset($loan_list) && is_array($loan_list) && 0 < count($loan_list)) {
	...
	foreach ($loan_list as $key => $values) {
		foreach ($values as $value) {
			$loan_no               =  !empty($value[COLUMN_1600030]) ? sprintf("%03d", $value[COLUMN_1600030]) : "&nbsp;";
			...
			echo "	<div id=\"horizontal\" style=\"width:1200px;border:0px solid blue;\">".LINE_FEED_CODE;
			echo "		<div class=\"label50_center\"><a href=\"../".REDIRECT_C050."/".REDIRECT_A050160."?".GET_PARAM_INDEX_LOAN_NO."=".$loan_no."\" target=\"blank\")>&nbsp;".$loan_no."&nbsp;</a></div>".LINE_FEED_CODE;
